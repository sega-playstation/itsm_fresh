...
/**
 * Opens a page that lists all Resolved tickets in the Incidents table
 * @returns The Incident List of all Resolved tickets
 */
export default function ResolvedIncidentTicketsPage() {
